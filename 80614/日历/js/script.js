...
var urlHost,imgBase1,imgBase2,imgBase3,imgBase4,imgBase5,lunar,fontIndex = randomNum(0,typeInfo[dateType].itemType[itemType].fontList.length-1),uploadLock = false,itemBtnFlag = true;
...
$(function(){
    setHTTP();
    loadingBefore(loadingImgs,function(){
...
function imgEnd() {
    ...
    var ctx=c.getContext("2d");
        ...
        img.onload = function(){
            ...
            // 照片
            ctx.drawImage(img,yleft,$(".upload-wrap")[0].offsetTop*pxScaleNum+$(".upload-box")[0].offsetTop*pxScaleNum,$("#canvas").width()*pxScaleNum - 2*yleft,$("#canvas").height()*pxScaleNum);
            // console.log("照片绘制成功");
                ...
                imgDateDay.onload = function(){
                    ctx.drawImage(imgDateDay,$(".date-yang-day")[0].offsetLeft*pxScaleNum-21.8,$(".date-yang-day")[0].offsetTop*pxScaleNum-18.2);
                    // console.log("阳历日绘制成功");
                    // 阳历 年
                    ctx.textBaseline="top";
                    ctx.fillStyle = typeInfo[dateType].itemType[itemType].fontColor;
                    ...
                    // 文字
                    $(".sfd").css("font-size",typeInfo[dateType].itemType[itemType].endFontSize);
                    ctx.textBaseline="top";
                    ctx.fillStyle = typeInfo[dateType].itemType[itemType].fontColor;
                    ctx.font ="13px" +" 'Microsoft YaHei'";
                    $(".sfd"+typeInfo[dateType].itemType[itemType].fontList.length+" span").html($(".swiper-slide-active .customFont").val());
                    if(fontIndex ==typeInfo[dateType].itemType[itemType].fontList.length ){
                        ctx.fillText($(".swiper-slide-active .customFont").val(),dleft,stop+80);
                    }else{
                        ...
                        imgEq.onload = function(){
                            ctx.drawImage(imgEq,wleft,wtop+100);
